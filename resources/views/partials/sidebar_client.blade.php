<aside class="sidebar" style="display:flex;flex-direction:column;height:100vh;">
    <div class="logo" style="width:100%;display:flex;justify-content:center;align-items:center;">
        <div style="background:#fff;border-radius:18px;padding:0.7rem 1.2rem;box-shadow:0 2px 8px rgba(91,48,126,0.10);display:flex;align-items:center;justify-content:center;width:100%;">
            <a href="{{ route('incidents.index') }}" style="display:flex;align-items:center;justify-content:center;width:100%;">
    ...
    <div class="nav-links" style="flex:1 1 auto;display:flex;flex-direction:column;">
        <a href="{{ route('incidents.create') }}" class="btn sidebar-link">
            <span class="sidebar-icon">
                <svg width="22" height="22" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="16"/><line x1="8" y1="12" x2="16" y2="12"/></svg>
            </span>
            <span class="sidebar-text">Créer un Incident</span>
        </a>
        <a href="{{ route('incidents.index') }}" class="btn sidebar-link">
            <span class="sidebar-icon">
            ...
            <span class="sidebar-text">Mes Incidents</span>
        </a>
        @php
            $user = Auth::user();
        @endphp
