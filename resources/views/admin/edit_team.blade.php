    ...
    <div style="flex:1;display:flex;align-items:center;justify-content:center;">
        <div style="width:100%;max-width:480px;background:#fff;padding:2.5rem 2rem 2rem 2rem;border-radius:18px;box-shadow:0 8px 32px rgba(91,48,126,0.10);">
            <div style="display:flex;align-items:center;gap:1rem;margin-bottom:2rem;">
                ...
                <h1 style="margin:0;font-size:1.6rem;color:#5B307E;font-weight:700;">Modifier l'équipe</h1>
            </div>
            @if(session('success'))
            ...
            <form action="{{ route('admin.update.team', $team->id) }}" method="POST">
                ...
                <div class="form-group" style="margin-bottom:1.2rem;">
                    ...
                    <input type="text" name="name" id="name" class="form-control" required value="{{ old('name', $team->name) }}" style="border-radius:8px;padding:0.8rem 1rem;font-size:1rem;width:100%;">
                </div>
                <div class="form-group" style="margin-bottom:1.2rem;">
                    ...
                    <input type="text" name="specialization" id="specialization" class="form-control" required value="{{ old('specialization', $team->specialization) }}" style="border-radius:8px;padding:0.8rem 1rem;font-size:1rem;width:100%;">
                </div>
